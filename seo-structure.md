...
## 2. Структура /routes/ (482 страницы)

**Расчёт:**
- Москва ↔ 16 областных центров: 16 × 2 = 32 страницы
- СПб ↔ 15 областных центров: 15 × 2 = 30 страниц
- 15 областных центров между собой: 15 × 14 × 2 = 420 страниц
- **ИТОГО: 32 + 30 + 420 = 482 страницы**
