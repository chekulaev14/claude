...
## SEO-структура /regions/

### Города для реализации (48 городов):
...
1. ✅ Составить структуру сайта (48 городов + 186 маршрутов)

#### Этап 2: Семантическое ядро ⏳
2. ✅ Собрать семантическое ядро для страниц городов
   - Целевой объем: 10-17 ключей на страницу города
   - 1-2 основных высокочастотных ключа
   - 8-15 LSI-фраз (связанные запросы)
3. ✅ Разбить семантику по кластерам (количество зависит от семантики)
...
4. ⏳ Собрать семантическое ядро для страниц маршрутов
   - Целевой объем: 6-11 ключей на страницу маршрута
   - 1 основной ключ (маршрут)
   - 5-10 дополнительных фраз

#### Этап 3: Шаблоны страниц городов ⏳
5. ⏳ Создать шаблон главной страницы города (index.html)
6. ⏳ Создать универсальный шаблон для страниц кластеров
...
#### Этап 4: Контент для городов ⏳
8. ⏳ Написать и разместить контент для страниц городов (48 городов × N кластеров)
   - Уникальные тексты для каждого города
   - Интеграция ключевых фраз
   - SEO-оптимизация

#### Этап 5: Шаблоны страниц маршрутов ⏳
9. ⏳ Создать шаблон страницы маршрута
10. ⏳ Продумать размещение ключевых фраз для маршрутов
11. ⏳ Заполнить мета-теги и структуру H1-H3

#### Этап 6: Контент для маршрутов ⏳
12. ⏳ Написать и разместить контент для страниц маршрутов (186 страниц)

#### Этап 7: Техническая оптимизация ⏳
13. ⏳ Добавить Schema.org разметку
14. ⏳ Создать sitemap.xml
15. ⏳ Настроить robots.txt

---

## SEO-структура /routes/

### Маршруты для реализации (272 страницы):

#### 1. Москва ↔ 16 областных центров (32 страницы)
...
#### 2. СПб ↔ 15 областных центров без Москвы (30 страниц)
...
#### 3. Межрегиональные маршруты - 15 областных центров между собой (210 страниц)

**Казань (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Казани:*
...
**Самара (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Самары:*
...
**Калуга (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Калуги:*
...
**Обнинск (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Обнинска:*
...
**Тула (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Тулы:*
1. /routes/tula-kazan/
...
**Тверь (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Твери:*
1. /routes/tver-kazan/
...
**Ярославль (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Ярославля:*
...
**Нижний Новгород (14 маршрутов туда + 14 обратно = 28 страниц):**
...
**Нижнекамск (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Нижнекамска:*
...
**Набережные Челны (14 маршрутов туда + 14 обратно = 28 страниц):**
...
**Ижевск (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Ижевска:*
...
**Уфа (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Уфы:*
1. /routes/ufa-kazan/
2. /routes/ufa-samara/
3. /routes/ufa-kaluga/
...
**Челябинск (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Челябинска:*
...
**Екатеринбург (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Екатеринбурга:*
...
**Пермь (14 маршрутов туда + 14 обратно = 28 страниц):**
*Из Перми:*
1. /routes/perm-kazan/
